"""
Q: You are given an array of integers of length n, where each element ranges
...
# same as the question: check whether there is a circle in the array
"""
